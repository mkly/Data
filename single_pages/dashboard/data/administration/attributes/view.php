...
<?php foreach ($attributes as $ak) { ?>
	<div class="ccm-attribute"><img src="<?= $ak->getAttributeKeyIconSRC() ?>" width="16" height="16" /><a href="<?= $this->url('/dashboard/data/administration/attributes/edit', $dataType->dtID, $ak->getAttributeKeyID()) ?>"><?= $ak->getAttributeKeyDisplayName() ?></a></div>
<?php } ?>
</div>
